...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="50%">
	...
	<tr>
		<td align="left">Race: <?=$race?></td>
	</tr>
	<tr>
		<td align="left">Level: <?=$level?></td>
	</tr>
	<tr>
		<td align="left">To Next Level: <?=$tnl?></td>
	</tr>
	<tr>
		<td align="left">XP: <?=$xp?></td>
	</tr>
	<tr>
		<td align="left"><font color="#006600"><b>Gold: <?=$gold?></b></font></td>
	</tr>
	<tr>
		<td align="left">Armor Class: <?=$armor_class?></td>
	</tr>
	<tr>
		<td align="left">Weapon: <?=$weapon?></td>
	</tr>
	<tr>
		<td align="left">Armor: <?=$armor?></td>
	</tr>
	<tr>
		<td height="20"></td>
	</tr>
	<tr>
		<td align="left">Strength: <?=$strength?></td>
	</tr>
	<tr>
		<td align="left">Dexterity: <?=$dexterity?></td>
	</tr>
	<tr>
		<td align="left">Intelligence: <?=$intelligence?></td>
	</tr>
	<tr>
		<td align="left">Constitution: <?=$constitution?></td>
	</tr>
	<tr>
		<td height="20"></td>
	</tr>
	<tr>
		<td align="left"><b><font color="red">HP:</font> <?=$cur_hp?>/<?=$max_hp?></b></td>
	</tr>
	<tr>
		<td align="left"><b><font color="blue">Mana:</font> <?=$cur_mana?>/<?=$max_mana?></b></td>
	</tr>
	<tr>
		<td align="left">Min DMG: <?=$min_dmg?></td>
	</tr>
	<tr>
		<td align="left">Max DMG: <?=$max_dmg?></td>
	</tr>
</table>
<br>
<table cellpadding="0" cellspacing="0" border="1" align="center" width="50%">
	<tr align="center">
		...
		<td><a href="heal.php">Healer Shop</a></td>
	</tr>
	<tr align="center">
		<td><a href="inventory.php">Inventory</a></td>
		<td><a href="spell.php">Spell Shop</a></td>
		<td><a href="fight.php">Fight Monsters</a></td>
	</tr>
</table>
</body>
</html>
