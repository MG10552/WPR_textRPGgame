...
<table cellpadding="0" cellspacing="0" border="1" align="center" width="50%" bordercolor="black">
	<tr>
		<td colspan="4" align="center"><h2><u>Weapon Shop</u></h1></td>
	</tr>
	<tr>
		<td colspan="4">
			<table align="center" cellpadding="0" cellspacing="0" border="0" align="left" width="50%">
				<tr>
					<td align="left"><b>Current Weapon: <?=$weapon?></b></td>
				</tr>
				<tr>
					<td align="left"><b>Sell Value: <?=$cost?></b></td>
				</tr>
				<tr>
					<td align="left"><b>Min Damage: <?=$min_dmg?></b></td>
				</tr>
				<tr>
					<td align="left"><b>Max Damage: <?=$max_dmg?></b></td>
				</tr>				
			</table>
		</td>
	</tr>
	<tr>
		<td colspan="4" align="center"><font color="#009900"><b>Gold: <?=$gold?></b></font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td bgcolor="#999999" align="center">Price</td>		
	</tr>
	<?
		$y--;
		while($y >= 0) {
